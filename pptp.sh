...
#wget ftp://ftp.ntua.gr/pub/net/poptop/pptpd/pptpd-1.2.3/pptpd-1.2.3-1.i386.rpm

yum -y install make libpcap iptables gcc-c++ logrotate tar cpio perl pam tcp_wrappers dkms ppp pptp pptpd
